...
- "addElements" / "removeElements": short noun phrases for anything explicitly requested to be added or removed. When there is nothing to add/remove, use an empty array [] for that field — never null; these fields' type is always an array, never null.
