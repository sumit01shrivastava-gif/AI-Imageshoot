...
beforeAll(async () => {
  ...
  // One test requests multiple outputs from a single job — the FREE
  // plan's maxOutputsPerGeneration is 1 (services/billing/plans.ts), so
  // this shop needs a real plan that allows more.
